...
<a href="https://magical-scone-8f6a60.netlify.app" target="_blank"><button  className="button s-button">Live</button></a>
        ...
        <div class="project">
          ...
          <h2>Image App</h2>
          <p> Where User can view the image and search the image. They can explore the variety of image. 
              Here I used React,NodejS and Cloudinary</p>
          <div class="links">
          <a href="https://github.com/Rafiyathanvir/IMAGEEXPLORECLIENT" target="_blank"><button className="button s-button">Frontend</button></a>
        

          &nbsp;
          &nbsp;

          <a href="https://github.com/Rafiyathanvir/IMAGEEXPLORE" target="_blank"><button className="button s-button">Backend</button></a>

          &nbsp;
          &nbsp;
          <a href="https://unrivaled-beignet-a6669c.netlify.app" target="_blank"><button className="button s-button" id="btn">Live</button></a>
